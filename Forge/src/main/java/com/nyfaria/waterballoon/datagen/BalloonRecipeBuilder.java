...
public class BalloonRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    */
   public BalloonRecipeBuilder define(Character pSymbol, TagKey<Item> pTag) {
    ...
    * Adds a key to the recipe pattern.
    */
   public BalloonRecipeBuilder define(Character pSymbol, ItemLike pItem) {
    ...
    * Adds a key to the recipe pattern.
    */
   public BalloonRecipeBuilder define(Character pSymbol, Ingredient pIngredient) {
    ...
    */
   public BalloonRecipeBuilder pattern(String pPattern) {
   ...
   public BalloonRecipeBuilder unlockedBy(String pCriterionName, CriterionTriggerInstance pCriterionTrigger) {
      this.advancement.addCriterion(pCriterionName, pCriterionTrigger);
      return this;
   }

   public BalloonRecipeBuilder group(@Nullable String pGroupName) {
